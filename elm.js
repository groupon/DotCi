...
Elm.Job.make = function (_elm) {
   ...
   $Text = Elm.Text.make(_elm);
   var show = function (value) {
      return $Graphics$Element.leftAligned($Text.monospace($Text.fromString($Basics.toString(value))));
   };
   var main = show("Hello World!");
   _elm.Job.values = {_op: _op
                     ,main: main
                     ,show: show};
   return _elm.Job.values;
};
